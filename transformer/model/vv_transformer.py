  ...
  """
    ...
    """
        ...
        with tf.variable_scope(self.scope, initializer=initializer):
            ...
            # sequence is known.
            if targets is None:
                return self.predict(encoder_outputs, attention_bias),encoder_outputs,attention_bias
            else:
                logits = self.decode(targets, encoder_outputs, attention_bias)
                return logits,encoder_outputs,attention_bias
...
class EncoderStack(tf.layers.Layer):
  ...
  """
    ...
    """
        ...
        for n, layer in enumerate(self.layers):
            ...
            with tf.variable_scope("layer_%d" % n):
                with tf.variable_scope("self_attention"):
                    ...
                    # encoder_layer_outputs.append(encoder_inputs)
        ...
        #return self.output_normalization(encoder_inputs),encoder_layer_outputs
