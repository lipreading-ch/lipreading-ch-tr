...
class BaseEstimator(object):
    ...
    def evaluate(self, eval_input_fn, steps=None, checkpoint_path=None):
        ...
        """
        predictions = self.estimator.evaluate(
    ...
    def predict(self, predict_input_fn, checkpoint_path=None):
        ...
        for prediction in predictions:
            print (str(prediction["predictions"],encoding = "UTF8"))
    ...
    def cal_pinyin_metrics(self, labels, predictions):
        """ calculate cer, wer
